...
import br.edu.ifrs.bank.repository.UserRepository;
...
public class UserService {
    ...
    @Inject
    AdminAuditUserService auditService;
    ...
    public TokenResponseDTO login(Long userId, String password) {
        ...
        try {
            ...
            return new TokenResponseDTO(token, user.getRole().name(), user.getUsername());
